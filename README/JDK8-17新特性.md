...
```java
public class BuiltInFunctionInterfaceTest {
    @Test
...
//        list.forEach( s -> System.out.println(s));
        list.forEach(System.out::println);  //lambda引用
    }
    @Test
    ...
    public void functionTest() {
        ...
        String apply = fun.apply(99);
        System.out.println(apply.getClass().getName()); //java.lang.String

        Function<Integer, String> fun1 = (integer) -> String.valueOf(integer + 1);
        System.out.println(fun1.apply(99));
        Function<Integer, String> fun2 = String::valueOf;
        System.out.println(fun2.apply(99));
    }
    @Test
